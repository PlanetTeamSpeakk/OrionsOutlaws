-- Source: https://hackage.haskell.org/package/gloss-juicy
-- For some reason, I cannot install this package. It has no specified version for the Stack configuration.
